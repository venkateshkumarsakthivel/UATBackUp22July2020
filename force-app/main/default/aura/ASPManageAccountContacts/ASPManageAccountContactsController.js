({
    ...
    confirmContactDeactivate: function(component, event, helper) {
        ...
        else if(haslevycontactaccess) {
            
            //if(counter > 1)
            confirmationMessage = "You are attempting to remove levy contact, please make sure to update the levy contact";
        //}
            //else {
               //confirmationMessage = 
            // }
        }
       else if(hasDVDcontactaccess)
            confirmationMessage = "You are attempting to remove DVD contact, please make sure to update the DVD contact";
    ...
    if(haslevycontactaccess == "true" && recordSelected && counter == 1)  {
       ...
       // if(counter == 1) {
               console.log('sreesunkara');
               var toastEvent = $A.get("e.force:showToast");           	
               toastEvent.setParams({
                   "title": "Error",
                   "message": "you cannot delete the last levy contact.",
                   "type": "error",
                   "duration":10000
               });
               toastEvent.fire();
