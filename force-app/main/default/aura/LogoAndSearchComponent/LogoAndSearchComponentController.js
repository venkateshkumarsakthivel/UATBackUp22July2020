        ...
        action.setCallback(this, function(response) {
            ...
            if(state === "SUCCESS") {
                ...
                if(loggedIn == true || loggedIn == "true") {
                    ...
                    if(profile == 'DVD User'){
                        $A.util.addClass(component.find("accountMenu"), 'hideMenu');
                        $A.util.addClass(component.find("levyMenu"), 'hideMenu');
                    }
                    console.log('profile :'+profile);
                    if(profile == 'Levy'){
                        $A.util.addClass(component.find("accountMenu"), 'hideMenu');
                        $A.util.addClass(component.find("dvdMenu"), 'hideMenu');
                    }                            
